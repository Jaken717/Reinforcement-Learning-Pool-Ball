...
class GameState:
    def __init__(self):
        ...
        self.last_potted_balls = []  # Add attribute to store last potted balls
        self.p2_win = False  # Add attribute to track if Player 2 won
    ...
    def set_pool_balls(self):
        ...
        ball_placement_sequence = [1, 2, 11, 10, 8, 3, 4, 13, 5, 12, 15, 6, 9, 14, 7]
    ...
    def reset_state(self):
        ...
        self.table_sides = []
        self.last_potted_balls = []  # Reset last potted balls
        self.p2_win = False  # Reset Player 2 win status
    ...
    def on_next_hit(self):
        ...
        self.last_potted_balls = self.potted.copy()  # Store potted balls before clearing
        self.potted = []
    ...
    def get_player_ball_type(self, player):
        ...
        return "Striped" if self.ball_assignment[player] == BallType.Striped else "Solid"
